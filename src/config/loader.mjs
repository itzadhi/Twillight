...
export function loadConfig(argv) {
  ...
  const env = compactObject({
    ...
    updateCheck: bool(process.env.TWILLIGHT_UPDATE_CHECK),
    autoUpdate: bool(process.env.TWILLIGHT_AUTO_UPDATE),
    updateCheckIntervalHours: number(process.env.TWILLIGHT_UPDATE_INTERVAL_HOURS),
    updateRegistryUrl: process.env.TWILLIGHT_UPDATE_REGISTRY_URL,
